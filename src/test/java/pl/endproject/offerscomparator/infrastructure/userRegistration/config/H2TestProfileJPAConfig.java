package pl.endproject.offerscomparator.infrastructure.userRegistration.config;
...
public class H2TestProfileJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"pl.endproject.offerscomparator.infrastructure.userRegistration.model"});
